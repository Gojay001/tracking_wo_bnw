...
class resnetv1(Network):
  ...
  def _head_to_tail(self, pool5):
    fc7 = self.RCNN_top(pool5).mean(3).mean(2) # average pooling after layer4
    return fc7
  ...
  def _init_head_tail(self):
    ...
    self.RCNN_bbox_pred = nn.Linear(2048, 8)
  ...
  def load_pretrained_cnn(self, state_dict):
    resnet.load_state_dict({k: state_dict[k] for k in list(resnet.state_dict())})
